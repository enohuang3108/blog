...
<Note title="Note">
  上面這段 JS 需要用 `<script></script>` 來執行，this 才會是 window，如果用 `
  <script type="module"></script>`，this 會是 undefined
</Note>
...
#### 怎麼導入 [@microsoft/fetch-event-source](https://github.com/Azure/fetch-event-source)

前面有說到 @microsoft/fetch-event-source 有提供 CJS 與 ESM 的版本，我們就分別以兩種方式導入 Library。
...
<Note title="為什麼需要轉成 UMD? Browser 不是支援 ESM 嗎?">
...
[Node.js ESM (nearform.com)](https://commerce.nearform.com/blog/2021/node-esm-and-exports)
