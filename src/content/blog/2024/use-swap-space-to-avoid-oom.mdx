...
import bashtop from '@/assets/2024/use-swap-space-to-avoid-oom/bashtop.png';
import bashtopSwap from '@/assets/2024/use-swap-space-to-avoid-oom/bashtop-swap.png';
...
<ImageZoom client:visible>
  <Image src={bashtop} alt="Bashtop" />
</ImageZoom>

最後在使用 Swap 的情況下終於不會 OOM 了(灑花)，在 RAM 吃滿16G的情況下，Swap 甚至一度吃到 18G。

<ImageZoom client:visible>
  <Image src={bashtopSwap} alt="Bashtop" />
</ImageZoom>
