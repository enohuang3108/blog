...
import umamiVariables from '@/assets/2025/deploy-umami-with-vercel/umami-variables.webp';
import awsLatencyTest from '@/assets/2025/deploy-umami-with-vercel/aws-latency-test.webp';
...
<ImageZoom client:visible>
  <Image src={umamiVariables} alt="umami-variables" />
</ImageZoom>
...
<ImageZoom client:visible>
  <Image src={awsLatencyTest} alt="aws-latency-test" />
</ImageZoom>
