...
import mcpArchitecture from '@/assets/2025/introducing-mcp/mcp-architecture.webp';
import mcpClientServerArchitecture from '@/assets/2025/introducing-mcp/mcp-client-server-architecture.webp';
import beforeMcpDevelopment from '@/assets/2025/introducing-mcp/before-mcp-development.webp';
import afterMcpDevelopment1 from '@/assets/2025/introducing-mcp/after-mcp-development-1.webp';
import afterMcpDevelopment2 from '@/assets/2025/introducing-mcp/after-mcp-development-2.webp';
import mcpFlow from '@/assets/2025/introducing-mcp/mcp-flow.webp';
import mcpStdioTransport from '@/assets/2025/introducing-mcp/mcp-stdio-transport.webp';
import mcpStreamableHttp from '@/assets/2025/introducing-mcp/mcp-streamable-http.webp';
import mcpStatelessHttp from '@/assets/2025/introducing-mcp/mcp-stateless-http.webp';
...
<ImageZoom client:visible>
  <Image src={mcpArchitecture} alt="MCP-intro" />
</ImageZoom>
...
<ImageZoom client:visible>
  <Image src={mcpClientServerArchitecture} alt="Introducing MCP" />
</ImageZoom>
...
**使用 MCP 之前：**
<ImageZoom client:visible>
  <Image src={beforeMcpDevelopment} alt="使用 MCP 之前" class="w-1/2 rounded-lg mx-auto" />
</ImageZoom>
...
<div class="flex gap-4">
  <ImageZoom client:visible>
    <Image src={afterMcpDevelopment1} alt="使用 MCP 之後" class="rounded-lg" />
  </ImageZoom>
  <ImageZoom client:visible>
    <Image src={afterMcpDevelopment2} alt="使用 MCP 之後" class="rounded-lg" />
  </ImageZoom>
</div>
...
<ImageZoom client:visible>
  <Image src={mcpFlow} alt="MCP Flow" />
</ImageZoom>
...
<ImageZoom client:visible>
  <Image src={mcpStdioTransport} alt="STDIO" />
</ImageZoom>
...
<ImageZoom client:visible>
  <Image src={mcpStreamableHttp} alt="Streamable MCP" />
</ImageZoom>
...
<ImageZoom client:visible>
  <Image src={mcpStatelessHttp} alt="Stateless HTTP" />
</ImageZoom>
