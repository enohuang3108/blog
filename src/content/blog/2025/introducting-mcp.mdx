...
<ImageZoom client:visible>
  <img src="/2025/introducing-mcp/mcp-architecture.webp" alt="MCP-intro" />
</ImageZoom>
...
<ImageZoom client:visible>
  <img src="/2025/introducing-mcp/mcp-client-server-architecture.webp" alt="Introducing MCP" />
</ImageZoom>
...
<div class="flex gap-4">
  <ImageZoom client:visible>
    <img src="/2025/introducing-mcp/after-mcp-development-1.webp" alt="使用 MCP 之後" class="rounded-lg" />
  </ImageZoom>
  <ImageZoom client:visible>
    <img src="/2025/introducing-mcp/after-mcp-development-2.webp" alt="使用 MCP 之後" class="rounded-lg" />
  </ImageZoom>
</div>
...
<ImageZoom client:visible>
  <img src="/2025/introducing-mcp/mcp-flow.webp" alt="MCP Flow" />
</ImageZoom>
...
<ImageZoom client:visible>
  <img src="/2025/introducing-mcp/mcp-stdio-transport.webp" alt="STDIO" />
</ImageZoom>
...
<ImageZoom client:visible>
  <img src="/2025/introducing-mcp/mcp-streamable-http.webp" alt="Streamable MCP" />
</ImageZoom>
...
<ImageZoom client:visible>
  <img src="/2025/introducing-mcp/mcp-stateless-http.webp" alt="Stateless HTTP" />
</ImageZoom>
